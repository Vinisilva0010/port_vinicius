            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="p-4 sm:p-6 md:p-8 flex flex-col flex-1 bg-[#f9f9f9] relative">
                            ...
                            {showDetails && (
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        <h4 className={`text-xl sm:text-2xl text-black mb-3 sm:mb-4 underline ${titleFont.className}`}>Notas:</h4>
                                        ...
                                        <button onClick={(e) => { e.stopPropagation(); setShowDetails(false); }} className="mt-4 sm:mt-8 text-xs sm:text-sm font-black text-red-600 hover:underline active:underline">
                                            [ FECHAR ]
                                        </button>
                                    </div>
                                </motion.div>
                        ...
                        <h3 className={`text-2xl sm:text-3xl text-black mb-2 sm:mb-4 ${titleFont.className}`}>{webProjects[currIndex].title}</h3>
                        <p className={`text-gray-700 mb-4 sm:mb-6 flex-1 text-sm sm:text-base md:text-lg ${handFont.className}`}>{webProjects[currIndex].desc}</p>
                        ...
                        <div className="grid grid-cols-2 gap-2 sm:gap-4">
                            ...
                            <a href={webProjects[currIndex].github} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center py-2 sm:py-3 text-sm sm:text-base bg-black hover:bg-gray-800 text-white font-bold border-3 sm:border-4 border-black shadow-[3px_3px_0px_#000] sm:shadow-[4px_4px_0px_#000] rounded-lg sm:rounded-xl active:translate-y-1 active:shadow-none">
                                GITHUB
                            </a>
                        </div>
                    </div>
